...
- **SB Acoustics Satori WO24P-8** (`sb-satori-wo24p-8`), HiFiCompass: stored hd-frequency 91 dB, thd-bands 91 dB. Page: <https://hificompass.com/ru/speakers/measurements/satori/satori-wo24p-8> (what it offers: `capture/inventory.md`).
  ...
  HiFiCompass shows 9 of this page's charts that the database keeps (current distortion, harmonics, impedance, intermodulation, near field, off-axis, on-axis response) only to Premium accounts (a notice picture in their place, `watch/completeness.md`): capture them logged in with Premium (`capture/CHROME_CAPTURE.md`, the section on Premium charts).
...
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`): sets 37: Axial frequency response @ 2.83 V; 38: Axial frequency response @ 4 V; 39: Axial frequency response @ 5.6 V; 40: Axial frequency response @ 8 V; 41: Axial frequency response @ 11.2 V; 42: Axial frequency response @ 16 V; 43: Axial frequency response @ 22 V; 44: Off-axis response; 45: Off-axis response (relative to on axis, chart range 10-50 dB); 46: Off-axis response (relative to on axis, chart range 5-30 dB); 47: Near-field frequency response @ 1 V (near field 3 mm); 48: HD (orders) vs frequency @ 2.83 V; 49: HD (orders) vs frequency @ 4 V; 50: HD (orders) vs frequency @ 5.6 V; 51: HD (orders) vs frequency @ 8 V; 52: HD (orders) vs frequency @ 11.2 V; 53: HD (orders) vs frequency @ 16 V; 54: HD (orders) vs frequency @ 22 V; 55: HD (orders) vs frequency @ 2.83 V (near field 20 mm); 56: HD (orders) vs frequency @ 4 V (near field 20 mm); 57: HD (orders) vs frequency @ 5.6 V (near field 20 mm); 58: HD (orders) vs frequency @ 8 V (near field 20 mm); 59: HD (orders) vs frequency @ 11.2 V (near field 20 mm); 60: HD (orders) vs frequency @ 16 V (near field 20 mm); 61: Voice-coil current HD vs frequency @ 2.83 V; 62: Voice-coil current HD vs frequency @ 4 V; 63: Voice-coil current HD vs frequency @ 5.6 V; 64: Voice-coil current HD vs frequency @ 8 V; 65: Voice-coil current HD vs frequency @ 11.2 V; 66: Impedance (chart to 100 ohm); 67: Impedance (chart to 15 ohm)
- **SB Acoustics Satori MR16TX-8** (`sb-satori-mr16tx-8`): sets 10: Axial frequency response @ 2.83 V; 11: Axial frequency response @ 4 V; 12: Axial frequency response @ 5.6 V; 13: Axial frequency response @ 8 V; 14: Axial frequency response @ 11.2 V; 15: Axial frequency response @ 16 V; 16: Off-axis response; 17: Off-axis response (relative to on axis, chart range 10-50 dB); 18: Off-axis response (relative to on axis, chart range 5-30 dB); 19: Near-field frequency response @ 1 V (near field 5 mm); 20: HD (orders) vs frequency @ 2 V; 21: HD (orders) vs frequency @ 2.83 V; 22: HD (orders) vs frequency @ 4 V; 23: HD (orders) vs frequency @ 5.6 V; 24: HD (orders) vs frequency @ 8 V; 25: HD (orders) vs frequency @ 11.2 V; 26: HD (orders) vs frequency @ 16 V; 27: Voice-coil current HD vs frequency @ 2.83 V; 28: Voice-coil current HD vs frequency @ 4 V; 29: Voice-coil current HD vs frequency @ 5.6 V; 30: Impedance (chart to 150 ohm)
...
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 4: Axial frequency response @ 2 V — check on the image: SPL 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 5: Axial frequency response @ 2.83 V — check on the image: SPL 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 6: Axial frequency response @ 4 V — check on the image: SPL 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 7: Axial frequency response @ 5.6 V — check on the image: SPL 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 8: Axial frequency response @ 8 V — check on the image: SPL 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 9: Axial frequency response @ 11.2 V — check on the image: SPL 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 10: Off-axis response — check on the image: 0° 99 %, 15° 100 %, 30° 100 %, 45° 100 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 11: Off-axis response (relative to on axis, chart range 10-50 dB) — check on the image: 0° 99 %, 15° 100 %, 30° 99 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 12: Off-axis response (relative to on axis, chart range 5-30 dB) — check on the image: 0° 99 %, 15° 100 %, 30° 99 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 13: HD (orders) vs frequency @ 2 V — check on the image: H2 100 %, H3 99 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 14: HD (orders) vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 99 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 15: HD (orders) vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 16: HD (orders) vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 17: HD (orders) vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 99 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 18: HD (orders) vs frequency @ 11.2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 19: Voice-coil current HD vs frequency @ 2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 20: Voice-coil current HD vs frequency @ 2.83 V — check on the image: H2 100 %, H3 99 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 21: Voice-coil current HD vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 22: Voice-coil current HD vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 23: Voice-coil current HD vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 24: Voice-coil current HD vs frequency @ 11.2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 25: Impedance (chart to 15 ohm) — check impedance minimum against Re, read 3.94, stated 4.6; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT1.3T04-HAG-01** (`ptt13t04hag01`), set 26: Impedance (chart to 5 ohm) — check impedance minimum against Re, read 3.9, stated 4.6; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
...
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 15: Axial frequency response @ 2.83 V — check on the image: SPL 100 % of the read points lie on the drawn curve (within 2 px)
...
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 18: Axial frequency response @ 8 V — check on the image: SPL 99 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 19: Axial frequency response @ 11.2 V — check on the image: SPL 100 % of the read points lie on the drawn curve (within 2 px)
...
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 21: Off-axis response — check on the image: 0° 93 %, 15° 96 %, 30° 97 %, 45° 100 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 22: Off-axis response (relative to on axis, chart range 10-50 dB) — check on the image: 0° 96 %, 15° 96 %, 30° 95 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 23: Off-axis response (relative to on axis, chart range 5-30 dB) — check on the image: 0° 97 %, 15° 98 %, 30° 96 %, 45° 100 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 24: Near-field frequency response @ 2.83 V (near field 20 mm) — check on the image: SPL 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 25: HD (orders) vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 26: HD (orders) vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 27: HD (orders) vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 28: HD (orders) vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 29: HD (orders) vs frequency @ 11.2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 30: HD (orders) vs frequency @ 16 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 31: HD (orders) vs frequency @ 2.83 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 32: HD (orders) vs frequency @ 4 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 33: HD (orders) vs frequency @ 5.6 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 34: HD (orders) vs frequency @ 8 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 35: HD (orders) vs frequency @ 11.2 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 36: Voice-coil current HD vs frequency @ 1.41 V — check on the image: H2 100 %, H3 100 %, H5 98 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 37: Voice-coil current HD vs frequency @ 2 V — check on the image: H2 100 %, H3 100 %, H5 98 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 38: Voice-coil current HD vs frequency @ 2.83 V — check on the image: H2 99 %, H3 100 %, H5 98 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 39: Voice-coil current HD vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 40: Voice-coil current HD vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 41: Voice-coil current HD vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 42: Impedance (chart to 70 ohm) — check impedance minimum against Re, read 3.78, stated 3.55; check impedance peak against Fs, read hz 24.06, read ohm 49.84, stated fs 28.8; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT8.0X04-NAB-02** (`purifi-ptt8-0x04-nab-02`), set 43: Impedance (chart to 7 ohm) — check impedance minimum against Re, read 3.73, stated 3.55; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
...
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 50: Axial frequency response @ 4 V — check 4 V response at 1 kHz against the stated sensitivity (2.83 V, scaled by the voltage), read 89.5, expected 91.0, stated sens 88.0, difference db -1.5; check on the image: SPL 100 % of the read points lie on the drawn curve (within 2 px)
...
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 56: Off-axis response — check on the image: 0° 94 %, 15° 96 %, 30° 99 %, 45° 100 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 57: Off-axis response (relative to on axis, chart range 10-50 dB) — check on the image: 0° 99 %, 15° 93 %, 30° 97 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 58: Off-axis response (relative to on axis, chart range 5-30 dB) — check on the image: 0° 98 %, 15° 93 %, 30° 97 %, 45° 94 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 59: Near-field frequency response @ 2.83 V (near field 20 mm) — check on the image: SPL 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 60: HD (orders) vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 61: HD (orders) vs frequency @ 4 V — check on the image: H2 100 %, H3 99 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 62: HD (orders) vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 63: HD (orders) vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 64: HD (orders) vs frequency @ 11.2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 65: HD (orders) vs frequency @ 16 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 66: HD (orders) vs frequency @ 22.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 67: HD (orders) vs frequency @ 2.83 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 68: HD (orders) vs frequency @ 4 V (near field 20 mm) — check on the image: H2 99 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 69: HD (orders) vs frequency @ 5.6 V (near field 20 mm) — check on the image: H2 99 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 70: HD (orders) vs frequency @ 8 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 71: HD (orders) vs frequency @ 11.2 V (near field 20 mm) — check on the image: H2 100 %, H3 99 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 72: HD (orders) vs frequency @ 16 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 73: Voice-coil current HD vs frequency @ 2.83 V — check on the image: H2 97 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 74: Voice-coil current HD vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 75: Voice-coil current HD vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 76: Voice-coil current HD vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 77: Voice-coil current HD vs frequency @ 11.2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 78: Impedance (chart to 70 ohm) — check impedance minimum against Re, read 4.69, stated 3.9; check impedance peak against Fs, read hz 22.71, read ohm 60.64, stated fs 24; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT10.0X04-NAB-02** (`purifi-ptt10-0x04-nab-02`), set 79: Impedance (chart to 15 ohm) — check impedance minimum against Re, read 4.63, stated 3.9; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
...
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 31: Off-axis response — check on the image: 0° 98 %, 15° 98 %, 30° 96 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 32: Off-axis response (relative to on axis, chart range 10-50 dB) — check on the image: 0° 98 %, 15° 97 %, 30° 98 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 33: Off-axis response (relative to on axis, chart range 5-30 dB) — check on the image: 0° 97 %, 15° 97 %, 30° 98 %, 45° 94 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 34: Near-field frequency response @ 2.83 V (near field 20 mm) — check on the image: SPL 98 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 35: HD (orders) vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 36: HD (orders) vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 37: HD (orders) vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 38: HD (orders) vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 39: HD (orders) vs frequency @ 11.2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 40: HD (orders) vs frequency @ 16 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 41: HD (orders) vs frequency @ 2.83 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 42: HD (orders) vs frequency @ 4 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 97 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 43: HD (orders) vs frequency @ 5.6 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 99 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 44: HD (orders) vs frequency @ 8 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 45: Voice-coil current HD vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 46: Voice-coil current HD vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 47: Voice-coil current HD vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 48: Voice-coil current HD vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Purifi PTT6.5X04-NAA-08A** (`ptt65x04naa08a`), set 49: Impedance (chart to 70 ohm) — check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
...
- **BlieSMa M74T-6** (`m74t-6`), set 17: Off-axis response — check on the image: 0° 96 %, 15° 95 %, 30° 98 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74T-6** (`m74t-6`), set 18: Off-axis response (relative to on axis, chart range 10-50 dB) — check on the image: 0° 96 %, 15° 98 %, 30° 98 %, 45° 99 %, 60° 99 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74T-6** (`m74t-6`), set 19: Off-axis response (relative to on axis, chart range 5-30 dB) — check on the image: 0° 96 %, 15° 97 %, 30° 98 %, 45° 100 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74T-6** (`m74t-6`), set 20: HD (orders) vs frequency @ 1.41 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74T-6** (`m74t-6`), set 21: HD (orders) vs frequency @ 2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74T-6** (`m74t-6`), set 22: HD (orders) vs frequency @ 2.83 V — check on the image: H2 100 %, H3 99 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74T-6** (`m74t-6`), set 23: HD (orders) vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74T-6** (`m74t-6`), set 24: HD (orders) vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74T-6** (`m74t-6`), set 25: HD (orders) vs frequency @ 8 V — check on the image: H2 100 %, H3 99 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74T-6** (`m74t-6`), set 26: Voice-coil current HD vs frequency @ 1 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74T-6** (`m74t-6`), set 27: Voice-coil current HD vs frequency @ 1.41 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74T-6** (`m74t-6`), set 28: Voice-coil current HD vs frequency @ 2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74T-6** (`m74t-6`), set 29: Voice-coil current HD vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 99 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74T-6** (`m74t-6`), set 30: Impedance (chart to 70 ohm) — check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74T-6** (`m74t-6`), set 31: Impedance (chart to 15 ohm) — check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
...
- **BlieSMa M74A-6** (`m74a-6`), set 10: Off-axis response — check on the image: 0° 97 %, 15° 98 %, 30° 99 %, 45° 100 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74A-6** (`m74a-6`), set 11: Off-axis response (relative to on axis, chart range 10-50 dB) — check on the image: 0° 96 %, 15° 96 %, 30° 97 %, 45° 100 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74A-6** (`m74a-6`), set 12: Off-axis response (relative to on axis, chart range 5-30 dB) — check on the image: 0° 98 %, 15° 96 %, 30° 96 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74A-6** (`m74a-6`), set 13: HD (orders) vs frequency @ 1.41 V — check on the image: H2 100 %, H3 99 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74A-6** (`m74a-6`), set 14: HD (orders) vs frequency @ 2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74A-6** (`m74a-6`), set 15: HD (orders) vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74A-6** (`m74a-6`), set 16: HD (orders) vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74A-6** (`m74a-6`), set 17: HD (orders) vs frequency @ 5.6 V — check on the image: H2 99 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74A-6** (`m74a-6`), set 18: HD (orders) vs frequency @ 8 V — check on the image: H2 99 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74A-6** (`m74a-6`), set 19: Voice-coil current HD vs frequency @ 1.41 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74A-6** (`m74a-6`), set 20: Voice-coil current HD vs frequency @ 2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74A-6** (`m74a-6`), set 21: Voice-coil current HD vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa M74A-6** (`m74a-6`), set 22: Impedance (chart to 50 ohm) — check impedance minimum against Re, read 5.98, stated 5.6; check impedance peak against Fs, read hz 391.2, read ohm 45.26, stated fs 400.0; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
...
- **BlieSMa T25A-6** (`t25a-6`), set 6: Off-axis response — check on the image: 0° 94 %, 15° 96 %, 30° 99 %, 45° 99 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25A-6** (`t25a-6`), set 7: Off-axis response (relative to on axis, chart range 10-50 dB) — check on the image: 0° 94 %, 15° 97 %, 30° 97 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25A-6** (`t25a-6`), set 8: Off-axis response (relative to on axis, chart range 5-30 dB) — check on the image: 0° 93 %, 15° 98 %, 30° 98 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25A-6** (`t25a-6`), set 9: HD (orders) vs frequency @ 2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25A-6** (`t25a-6`), set 10: HD (orders) vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25A-6** (`t25a-6`), set 11: HD (orders) vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25A-6** (`t25a-6`), set 12: HD (orders) vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25A-6** (`t25a-6`), set 13: HD (orders) vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25A-6** (`t25a-6`), set 14: HD (orders) vs frequency @ 11.2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25A-6** (`t25a-6`), set 15: Impedance (chart to 15 ohm) — check impedance minimum against Re, read 5.5, stated 5.2; check impedance peak against Fs, read hz 805.33, read ohm 12.94, stated fs 980.0; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25A-6** (`t25a-6`), set 16: Impedance (chart to 7 ohm) — check impedance minimum against Re, read 5.48, stated 5.2; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
...
- **BlieSMa T25T-6** (`t25t-6`), set 5: Off-axis response — check on the image: 0° 98 %, 15° 97 %, 30° 97 %, 45° 100 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25T-6** (`t25t-6`), set 6: Off-axis response (relative to on axis, chart range 10-50 dB) — check on the image: 0° 98 %, 15° 97 %, 30° 95 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25T-6** (`t25t-6`), set 7: Off-axis response (relative to on axis, chart range 5-30 dB) — check on the image: 0° 96 %, 15° 98 %, 30° 97 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25T-6** (`t25t-6`), set 8: HD (orders) vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25T-6** (`t25t-6`), set 9: HD (orders) vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25T-6** (`t25t-6`), set 10: HD (orders) vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25T-6** (`t25t-6`), set 11: HD (orders) vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25T-6** (`t25t-6`), set 12: HD (orders) vs frequency @ 11.2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25T-6** (`t25t-6`), set 13: Voice-coil current HD vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25T-6** (`t25t-6`), set 14: Voice-coil current HD vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25T-6** (`t25t-6`), set 15: Voice-coil current HD vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25T-6** (`t25t-6`), set 16: Impedance (chart to 20 ohm) — check impedance minimum against Re, read 5.26, stated 5.2; check impedance peak against Fs, read hz 878.21, read ohm 15.24, stated fs 940.0; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T25T-6** (`t25t-6`), set 17: Impedance (chart to 7 ohm) — check impedance minimum against Re, read 5.25, stated 5.2; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
...
- **BlieSMa T34A-4** (`t34a-4`), set 7: Off-axis response — check on the image: 0° 94 %, 15° 95 %, 30° 98 %, 45° 99 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34A-4** (`t34a-4`), set 8: Off-axis response (relative to on axis, chart range 10-50 dB) — check on the image: 0° 95 %, 15° 98 %, 30° 95 %, 45° 100 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34A-4** (`t34a-4`), set 9: Off-axis response (relative to on axis, chart range 10-25 dB) — check on the image: 0° 93 %, 15° 96 %, 30° 96 %, 45° 100 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34A-4** (`t34a-4`), set 10: HD (orders) vs frequency @ 1.41 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34A-4** (`t34a-4`), set 11: HD (orders) vs frequency @ 2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34A-4** (`t34a-4`), set 12: HD (orders) vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34A-4** (`t34a-4`), set 13: HD (orders) vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34A-4** (`t34a-4`), set 14: HD (orders) vs frequency @ 5.6 V — check on the image: H2 100 %, H3 99 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34A-4** (`t34a-4`), set 15: HD (orders) vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34A-4** (`t34a-4`), set 16: Impedance (chart to 7 ohm) — check impedance minimum against Re, read 3.69, stated 3.3; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34A-4** (`t34a-4`), set 17: Impedance (chart to 20 ohm) — check impedance minimum against Re, read 3.73, stated 3.3; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
...
- **BlieSMa T34B-4** (`t34b-4`), set 6: Off-axis response — check on the image: 0° 96 %, 15° 98 %, 30° 96 %, 45° 100 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34B-4** (`t34b-4`), set 7: Off-axis response (relative to on axis, chart range 10-50 dB) — check on the image: 0° 94 %, 15° 95 %, 30° 96 %, 45° 98 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34B-4** (`t34b-4`), set 8: Off-axis response (relative to on axis, chart range 10-25 dB) — check on the image: 0° 94 %, 15° 95 %, 30° 98 %, 45° 99 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34B-4** (`t34b-4`), set 9: HD (orders) vs frequency @ 1.41 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34B-4** (`t34b-4`), set 10: HD (orders) vs frequency @ 2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34B-4** (`t34b-4`), set 11: HD (orders) vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34B-4** (`t34b-4`), set 12: HD (orders) vs frequency @ 4 V — check on the image: H2 100 %, H3 99 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34B-4** (`t34b-4`), set 13: HD (orders) vs frequency @ 5.6 V — check on the image: H2 100 %, H3 99 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34B-4** (`t34b-4`), set 14: HD (orders) vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34B-4** (`t34b-4`), set 15: Impedance (chart to 5 ohm) — check impedance minimum against Re, read 3.6, stated 3.3; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
- **BlieSMa T34B-4** (`t34b-4`), set 16: Impedance (chart to 20 ohm) — check impedance minimum against Re, read 3.63, stated 3.3; check impedance peak against Fs, read hz 760.13, read ohm 16.94, stated fs 790.0; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
...
- **SB Acoustics Satori MR16TX-8** (`sb-satori-mr16tx-8`), set 16: Off-axis response — check on the image: 0° 97 %, 15° 99 %, 30° 97 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MR16TX-8** (`sb-satori-mr16tx-8`), set 17: Off-axis response (relative to on axis, chart range 10-50 dB) — check on the image: 0° 98 %, 15° 95 %, 30° 98 %, 45° 94 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MR16TX-8** (`sb-satori-mr16tx-8`), set 18: Off-axis response (relative to on axis, chart range 5-30 dB) — check on the image: 0° 99 %, 15° 96 %, 30° 96 %, 45° 94 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MR16TX-8** (`sb-satori-mr16tx-8`), set 19: Near-field frequency response @ 1 V (near field 5 mm) — check on the image: SPL 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MR16TX-8** (`sb-satori-mr16tx-8`), set 20: HD (orders) vs frequency @ 2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MR16TX-8** (`sb-satori-mr16tx-8`), set 21: HD (orders) vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MR16TX-8** (`sb-satori-mr16tx-8`), set 22: HD (orders) vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MR16TX-8** (`sb-satori-mr16tx-8`), set 23: HD (orders) vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MR16TX-8** (`sb-satori-mr16tx-8`), set 24: HD (orders) vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MR16TX-8** (`sb-satori-mr16tx-8`), set 25: HD (orders) vs frequency @ 11.2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MR16TX-8** (`sb-satori-mr16tx-8`), set 26: HD (orders) vs frequency @ 16 V — check on the image: H2 99 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MR16TX-8** (`sb-satori-mr16tx-8`), set 27: Voice-coil current HD vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MR16TX-8** (`sb-satori-mr16tx-8`), set 28: Voice-coil current HD vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MR16TX-8** (`sb-satori-mr16tx-8`), set 29: Voice-coil current HD vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 99 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MR16TX-8** (`sb-satori-mr16tx-8`), set 30: Impedance (chart to 150 ohm) — check impedance minimum against Re, read 6.66, stated 6.2; check impedance peak against Fs, read hz 35.02, read ohm 107.47, stated fs 35.0; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
...
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 45: Off-axis response — check on the image: 0° 97 %, 15° 96 %, 30° 95 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 46: Off-axis response (relative to on axis, chart range 10-50 dB) — check on the image: 0° 99 %, 15° 98 %, 30° 97 %, 45° 94 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 47: Off-axis response (relative to on axis, chart range 5-30 dB) — check on the image: 0° 98 %, 15° 97 %, 30° 98 %, 45° 94 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 48: Near-field frequency response @ 2.83 V (near field 20 mm) — check on the image: SPL 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 49: HD (orders) vs frequency @ 2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 50: HD (orders) vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 51: HD (orders) vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 52: HD (orders) vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 53: HD (orders) vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 54: HD (orders) vs frequency @ 11.2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 55: HD (orders) vs frequency @ 2 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 56: HD (orders) vs frequency @ 2.83 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 57: HD (orders) vs frequency @ 4 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 58: HD (orders) vs frequency @ 5.6 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 59: HD (orders) vs frequency @ 8 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 60: Voice-coil current HD vs frequency @ 2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 61: Voice-coil current HD vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 62: Voice-coil current HD vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 63: Voice-coil current HD vs frequency @ 5.6 V — check on the image: H2 99 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 64: Voice-coil current HD vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 65: Impedance (chart to 70 ohm) — check impedance minimum against Re, read 4.0, stated 3.4; check impedance peak against Fs, read hz 32.12, read ohm 59.32, stated fs 32.0; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori MW19TX-4** (`sb-satori-mw19tx-4`), set 66: Impedance (chart to 7 ohm) — check impedance minimum against Re, read 3.93, stated 3.4; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
...
- **SB Acoustics Satori TW29BNWG-4** (`sb-satori-tw29bnwg-4`), set 10: Off-axis response — check on the image: 0° 98 %, 15° 99 %, 30° 100 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29BNWG-4** (`sb-satori-tw29bnwg-4`), set 11: Off-axis response (relative to on axis, chart range 10-50 dB) — check on the image: 0° 100 %, 15° 99 %, 30° 97 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29BNWG-4** (`sb-satori-tw29bnwg-4`), set 12: Off-axis response (relative to on axis, chart range 5-30 dB) — check on the image: 0° 99 %, 15° 99 %, 30° 96 %, 45° 100 %, 60° 99 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29BNWG-4** (`sb-satori-tw29bnwg-4`), set 13: HD (orders) vs frequency @ 1.41 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29BNWG-4** (`sb-satori-tw29bnwg-4`), set 14: HD (orders) vs frequency @ 2 V — check on the image: H2 100 %, H3 99 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29BNWG-4** (`sb-satori-tw29bnwg-4`), set 15: HD (orders) vs frequency @ 2.83 V — check on the image: H2 100 %, H3 99 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29BNWG-4** (`sb-satori-tw29bnwg-4`), set 16: HD (orders) vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29BNWG-4** (`sb-satori-tw29bnwg-4`), set 17: HD (orders) vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29BNWG-4** (`sb-satori-tw29bnwg-4`), set 18: HD (orders) vs frequency @ 8 V — check on the image: H2 99 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29BNWG-4** (`sb-satori-tw29bnwg-4`), set 19: HD (orders) vs frequency @ 11.2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29BNWG-4** (`sb-satori-tw29bnwg-4`), set 20: Voice-coil current HD vs frequency @ 1.41 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29BNWG-4** (`sb-satori-tw29bnwg-4`), set 21: Voice-coil current HD vs frequency @ 2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29BNWG-4** (`sb-satori-tw29bnwg-4`), set 22: Voice-coil current HD vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29BNWG-4** (`sb-satori-tw29bnwg-4`), set 23: Voice-coil current HD vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29BNWG-4** (`sb-satori-tw29bnwg-4`), set 24: Voice-coil current HD vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29BNWG-4** (`sb-satori-tw29bnwg-4`), set 25: Impedance (chart to 5 ohm) — check impedance minimum against Re, read 3.03, stated 3.0; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
...
- **SB Acoustics Satori TW29TXN-B** (`sb-satori-tw29txn-b`), set 8: Off-axis response — check on the image: 0° 97 %, 15° 99 %, 30° 100 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29TXN-B** (`sb-satori-tw29txn-b`), set 9: Off-axis response (relative to on axis, chart range 10-50 dB) — check on the image: 0° 98 %, 15° 99 %, 30° 99 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29TXN-B** (`sb-satori-tw29txn-b`), set 10: Off-axis response (relative to on axis, chart range 5-30 dB) — check on the image: 0° 97 %, 15° 99 %, 30° 98 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29TXN-B** (`sb-satori-tw29txn-b`), set 11: HD (orders) vs frequency @ 1.41 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29TXN-B** (`sb-satori-tw29txn-b`), set 12: HD (orders) vs frequency @ 2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29TXN-B** (`sb-satori-tw29txn-b`), set 13: HD (orders) vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29TXN-B** (`sb-satori-tw29txn-b`), set 14: HD (orders) vs frequency @ 4 V — check on the image: H2 100 %, H3 99 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29TXN-B** (`sb-satori-tw29txn-b`), set 15: HD (orders) vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29TXN-B** (`sb-satori-tw29txn-b`), set 16: HD (orders) vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 99 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29TXN-B** (`sb-satori-tw29txn-b`), set 17: Voice-coil current HD vs frequency @ 1.41 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29TXN-B** (`sb-satori-tw29txn-b`), set 18: Voice-coil current HD vs frequency @ 2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29TXN-B** (`sb-satori-tw29txn-b`), set 19: Voice-coil current HD vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29TXN-B** (`sb-satori-tw29txn-b`), set 20: Voice-coil current HD vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29TXN-B** (`sb-satori-tw29txn-b`), set 21: Voice-coil current HD vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 98 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29TXN-B** (`sb-satori-tw29txn-b`), set 22: Impedance (chart to 15 ohm) — check impedance minimum against Re, read 3.04, stated 3.0; check impedance peak against Fs, read hz 620.99, read ohm 10.31, stated fs 600.0; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori TW29TXN-B** (`sb-satori-tw29txn-b`), set 23: Impedance (chart to 5 ohm) — check impedance minimum against Re, read 3.04, stated 3.0; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
...
- **Wavecor TW030WA11** (`wavecor-tw030wa11`), set 5: Off-axis response — check on the image: 0° 98 %, 15° 100 %, 30° 98 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **Wavecor TW030WA11** (`wavecor-tw030wa11`), set 6: Off-axis response (relative to on axis, chart range 10-50 dB) — check on the image: 0° 98 %, 15° 98 %, 30° 97 %, 45° 100 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **Wavecor TW030WA11** (`wavecor-tw030wa11`), set 7: Off-axis response (relative to on axis, chart range 10-25 dB) — check on the image: 0° 100 %, 15° 97 %, 30° 96 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **Wavecor TW030WA11** (`wavecor-tw030wa11`), set 8: HD (orders) vs frequency @ 2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Wavecor TW030WA11** (`wavecor-tw030wa11`), set 9: HD (orders) vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Wavecor TW030WA11** (`wavecor-tw030wa11`), set 10: HD (orders) vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Wavecor TW030WA11** (`wavecor-tw030wa11`), set 11: HD (orders) vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Wavecor TW030WA11** (`wavecor-tw030wa11`), set 12: HD (orders) vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **Wavecor TW030WA11** (`wavecor-tw030wa11`), set 13: Impedance (chart to 5 ohm) — check impedance minimum against Re, read 3.51, stated 3.5; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
...
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 44: Off-axis response — check on the image: 0° 95 %, 15° 95 %, 30° 97 %, 45° 100 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 45: Off-axis response (relative to on axis, chart range 10-50 dB) — check on the image: 0° 97 %, 15° 97 %, 30° 99 %, 45° 94 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 46: Off-axis response (relative to on axis, chart range 5-30 dB) — check on the image: 0° 96 %, 15° 97 %, 30° 98 %, 45° 94 %, 60° 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 47: Near-field frequency response @ 1 V (near field 3 mm) — check on the image: SPL 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 48: HD (orders) vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 49: HD (orders) vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 50: HD (orders) vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 51: HD (orders) vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 52: HD (orders) vs frequency @ 11.2 V — check on the image: H2 100 %, H3 100 %, H5 99 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 53: HD (orders) vs frequency @ 16 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 54: HD (orders) vs frequency @ 22 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 55: HD (orders) vs frequency @ 2.83 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 56: HD (orders) vs frequency @ 4 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 57: HD (orders) vs frequency @ 5.6 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 58: HD (orders) vs frequency @ 8 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 59: HD (orders) vs frequency @ 11.2 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 60: HD (orders) vs frequency @ 16 V (near field 20 mm) — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 61: Voice-coil current HD vs frequency @ 2.83 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 62: Voice-coil current HD vs frequency @ 4 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 63: Voice-coil current HD vs frequency @ 5.6 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 64: Voice-coil current HD vs frequency @ 8 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 65: Voice-coil current HD vs frequency @ 11.2 V — check on the image: H2 100 %, H3 100 %, H5 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 66: Impedance (chart to 100 ohm) — check impedance minimum against Re, read 6.33, stated 5.8; check impedance peak against Fs, read hz 26.24, read ohm 91.05, stated fs 25.0; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
- **SB Acoustics Satori WO24TX-8** (`sb-satori-wo24tx-8`), set 67: Impedance (chart to 15 ohm) — check impedance minimum against Re, read 6.34, stated 5.8; check on the image: Z 100 % of the read points lie on the drawn curve (within 2 px)
